...
trk1 = DC.Track(1, 'cd1.track1', '01:59', 1)
trk2 = DC.Track(2, 'cd1.track2', '02:59', 1)
trk3 = DC.Track(1, 'cd2.track1', '03:33', 2)
trk4 = DC.Track(2, 'cd2.track2', '02:22', 2)
print('record for file:', trk1.get_record())

print('\n\nTesting CD class')
print(DC.CD.__doc__)
cd1 = DC.CD(1, 'test1', 'test1')
cd2 = DC.CD(2, 'test2', 'test2')
print(cd1)
...
print('\nSub Menu')
IO.ScreenIO.print_CD_menu(cd.cd_id)
