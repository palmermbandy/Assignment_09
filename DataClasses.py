...
class Track():
    ...
    properties:
        ...
        cd_id: (int) with the ID of the CD the track belongs to
    methods:
        get_record() -> (str)
    ...
    # -- Constructor -- #
    def __init__(self, position: int, title: str, length: str, cd_id = 0) -> None:
    ...
    # CD ID that track is associated with
    @property
    def cd_id(self):
        return self.__cd_id
    ...
    def cd_id(self, value):
        try:
            ...
            raise Exception('CD_ID needs to be Integer!')
    ...
    def get_record(self) -> str:
        ...
        return '{},{},{},{}\n'.format(self.position, self.title, self.length, self.cd_id)
...
class CD:
    ...
    def rmv_track(self, track_id: int) -> None:
        ...
        """
        track_to_delete = int(track_id) - 1
        del self.__tracks[track_to_delete]
        self.__sort_tracks()
